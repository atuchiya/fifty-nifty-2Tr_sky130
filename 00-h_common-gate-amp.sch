...
S {}
E {}
T {Common-Gate Amplifier} 20 -370 0 0 0.8 0.8 {layer=8}
T {High gain, low input impedance, high output impedance, non-inverting amplifier} 20 -310 0 0 0.4 0.4 {}
N -250 -130 -250 -110 {
lab=VDD}
N -250 -50 -250 -30 {
lab=GND}
...
C {devices/gnd.sym} -60 -30 0 0 {name=l3 lab=GND}
